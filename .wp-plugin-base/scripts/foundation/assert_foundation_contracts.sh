...
assert_file_contains_literal "$ROOT_DIR/.github/workflows/ci.yml" 'github/codeql-action/upload-sarif@68bde559dea0fdcac2102bfdf6230c5f70eb485e' "Root CI workflow must pin upload-sarif to the reviewed SHA."
assert_file_contains_literal "$ROOT_DIR/templates/child/.github/workflows/ci.yml" 'github/codeql-action/upload-sarif@68bde559dea0fdcac2102bfdf6230c5f70eb485e' "Child CI workflow must pin upload-sarif to the reviewed SHA."
assert_file_contains_literal "$ROOT_DIR/docs/security-model.md" 'github/codeql-action/upload-sarif@68bde559dea0fdcac2102bfdf6230c5f70eb485e' "Security documentation must advertise the reviewed upload-sarif SHA."
assert_file_contains_literal "$ROOT_DIR/scripts/ci/audit_workflows.sh" 'github/codeql-action/upload-sarif@68bde559dea0fdcac2102bfdf6230c5f70eb485e' "Workflow audit allowlist must include the reviewed upload-sarif SHA."
