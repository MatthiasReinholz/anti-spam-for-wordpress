...
assert_file_contains_literal "$ROOT_DIR/.github/workflows/update-foundation.yml" 'install_release_security_tools.sh' "Root update-foundation workflow must install release security tools before provenance verification."
