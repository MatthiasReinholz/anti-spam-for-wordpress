...
if ( ! class_exists( 'WP_Plugin_Base_Admin_UI_Loader' ) ) {
	...
	class WP_Plugin_Base_Admin_UI_Loader {
		...
		private static function enqueue_assets( array $config ) {
			...
			$script_url = plugins_url( 'assets/admin-ui/index.js', dirname( __DIR__, 3 ) . '/anti-spam-for-wordpress.php' );
			$style_url  = plugins_url( 'assets/admin-ui/style-index.css', dirname( __DIR__, 3 ) . '/anti-spam-for-wordpress.php' );
