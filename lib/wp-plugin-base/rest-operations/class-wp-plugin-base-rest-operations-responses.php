...
if ( ! class_exists( 'ASFW_WP_Plugin_Base_REST_Operations_Responses' ) ) {
	/**
	 * Normalizes callback responses.
	 *
	 * @since NEXT
	 */
	class ASFW_WP_Plugin_Base_REST_Operations_Responses {
		/**
		...
		private static function get_public_error_message( array $operation ) {
			...
			return __( 'The REST operation failed.', 'anti-spam-for-wordpress' );
		}
